...
def copyfiles(path):
    ...
    copyfile('ResNet18_AE.py', os.path.join(path, 'ResNet18_AE.py'))
    ...
    copyfile('utils/swd.py', os.path.join(path, 'swd.py'))
    copyfile('ksrun.sh', os.path.join(path, 'ksrun.sh'))
    copyfile('utils/qpsolver.py', os.path.join(path, 'qpsolver.sh'))
    return 0
